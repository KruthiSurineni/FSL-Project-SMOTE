    ...
    while (1):
        ...
        if (int(choice) == 1):
            ...
            try:
                ...
                print ("Number of Minority Samples(PIMA): " + str(minorityCounter))
                print ("Number of Majority Samples(PIMA): " + str(majorityCounter))
                ...
                # Naive Bayes
                print "Naive Bayes metrics for PIMA"
                ...
                files = ['Data/PIMA/Input/diabetes.csv', 'Data/PIMA/Output/diabetes_SMOTE_10.csv',
                         'Data/PIMA/Output/diabetes_SMOTE_15.csv',
                ...
                files = ['Data/PIMA/Input/diabetes.csv', 'Data/PIMA/Output/diabetes_Under_10.csv',
                         'Data/PIMA/Output/diabetes_Under_15.csv',
                         'Data/PIMA/Output/diabetes_Under_20.csv', 'Data/PIMA/Output/diabetes_Under_25.csv',
                         'Data/PIMA/Output/diabetes_Under_50.csv', 'Data/PIMA/Output/diabetes_Under_75.csv',
                         'Data/PIMA/Output/diabetes_Under_100.csv',
                         'Data/PIMA/Output/diabetes_Under_125.csv', 'Data/PIMA/Output/diabetes_Under_150.csv',
                         'Data/PIMA/Output/diabetes_Under_175.csv',
                         'Data/PIMA/Output/diabetes_Under_200.csv',
                         'Data/PIMA/Output/diabetes_Under_300.csv', 'Data/PIMA/Output/diabetes_Under_400.csv',
                         'Data/PIMA/Output/diabetes_Under_500.csv',
            ...
            try:
                ...
                # Naive Bayes
                print "Naive Bayes metrics for Phoneme"
                ...
                # C4.5 Decision Tree - Under
                files = ['Data/Phoneme/Input/phoneme.csv', 'Data/Phoneme/Output/phoneme_Under_10.csv',
                         # 'Data/Phoneme/Output/phoneme_Under_15.csv',
            ...
            try:
                ...
                # Naive Bayes
                print "Naive Bayes metrics for Satimage"
                ...
                # C4.5 Decision Tree - SMOTE
                files = ['Data/Satimage/Input/satimage.csv', 'Data/Satimage/Output/satimage_SMOTE_10.csv',
                         'Data/Satimage/Output/satimage_SMOTE_15.csv',
                ...
                # C4.5 Decision Tree - Under
                files = ['Data/Satimage/Input/satimage.csv', 'Data/Satimage/Output/satimage_Under_10.csv',
                         'Data/Satimage/Output/satimage_Under_15.csv',
