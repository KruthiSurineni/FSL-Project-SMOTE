    ...
    while (1):
        ...
        if (int(choice) == 1):
            ...
            try:
                ...
                files = ['Data/PIMA/Output/diabetes_Under_10.csv', 'Data/PIMA/Output/diabetes_Under_15.csv', 'Data/PIMA/Output/diabetes_Under_25.csv',
                ...
                plt.plot(undermean_fpr, undermean_tpr, color='r', label=r'C4.5 Under Sampling ROC (AUC = %0.2f)' % (undermean_auc), lw=2, alpha=.8)

                #C4.5 Decision Tree - SMOTE
                files = ['Data/PIMA/Output/diabetes_SMOTE_10.csv', 'Data/PIMA/Output/diabetes_SMOTE_15.csv', 'Data/PIMA/Output/diabetes_SMOTE_25.csv',
                         'Data/PIMA/Output/diabetes_SMOTE_50.csv', 'Data/PIMA/Output/diabetes_SMOTE_75.csv', 'Data/PIMA/Output/diabetes_SMOTE_100.csv',
                         'Data/PIMA/Output/diabetes_SMOTE_125.csv', 'Data/PIMA/Output/diabetes_SMOTE_150.csv', 'Data/PIMA/Output/diabetes_SMOTE_175.csv',
                         'Data/PIMA/Output/diabetes_SMOTE_200.csv',
                         'Data/PIMA/Output/diabetes_SMOTE_300.csv', 'Data/PIMA/Output/diabetes_SMOTE_400.csv', 'Data/PIMA/Output/diabetes_SMOTE_500.csv',
                ...
                plt.plot(smotemean_fpr, smotemean_tpr, color='g', label=r'C4.5 SMOTE + Under ROC (AUC = %0.2f)' % (smotemean_auc), lw=2, alpha=.8)
            ...
            try:
                ...
                # C4.5 Decision Tree - Under
                files = ['Data/Phoneme/Output/phoneme_Under_10.csv', 'Data/Phoneme/Output/phoneme_Under_15.csv', 'Data/Phoneme/Output/phoneme_Under_25.csv',
                         'Data/Phoneme/Output/phoneme_Under_50.csv', 'Data/Phoneme/Output/phoneme_Under_75.csv',
                         ...
                         'Data/Phoneme/Output/phoneme_Under_800.csv']
                ...
                # C4.5 Decision Tree - SMOTE
                files = ['Data/Phoneme/Output/phoneme_SMOTE_10.csv', 'Data/Phoneme/Output/phoneme_SMOTE_15.csv', 'Data/Phoneme/Output/phoneme_SMOTE_25.csv',
                         'Data/Phoneme/Output/phoneme_SMOTE_50.csv', 'Data/Phoneme/Output/phoneme_SMOTE_75.csv',
                         ...
                         'Data/Phoneme/Output/phoneme_SMOTE_800.csv']
            ...
            try:
                ...
                #     fUnder.close()
                #
                #     smoteforSatimage(satimageMinorityCounter, 300, 5, satimageMinoritySamples, fSmote)
                #     fSmote.close()
                #
                #     fSmote = open(filenameSMOTE, "a")
                #     fUnder = open(filenameUnder, "a")
                ...
                # C4.5 Decision Tree - Under
                files = ['Data/Satimage/Output/satimage_Under_10.csv', #'Data/Phoneme/Output/phoneme_Under_15.csv',
                ...
                # C4.5 Decision Tree - SMOTE
                files = ['Data/Satimage/Output/satimage_SMOTE_10.csv', #'Data/Phoneme/Output/phoneme_SMOTE_15.csv',
                         # 'Data/Phoneme/Output/phoneme_SMOTE_25.csv',
                         # 'Data/Phoneme/Output/phoneme_SMOTE_50.csv', 'Data/Phoneme/Output/phoneme_SMOTE_75.csv',
